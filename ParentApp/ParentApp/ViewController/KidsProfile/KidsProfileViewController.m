...
{  // set color
    lbl_sex.textColor = kLabelColor;
    lbl_DOB.textColor = kLabelColor;
    lbl_name.textColor = kLabelColor;
    lbl_specialNeeds.textColor = kLabelColor;
    lbl_alergies.textColor = kLabelColor;
    lbl_medication.textColor = kLabelColor;
    lbl_helpFullHint.textColor = kLabelColor;
    lbl_favouriteCartoon.textColor = kLabelColor;
    lbl_favouriteBook.textColor = kLabelColor;
    lbl_favouriteFood.textColor = kLabelColor;
    [btn_specialNeedsNo setTitleColor:kLabelColor forState:UIControlStateNormal];
    [btn_specialNeedsYes setTitleColor:kLabelColor forState:UIControlStateNormal];
    ...
    [btn_medicationYes setTitleColor:kLabelColor forState:UIControlStateNormal];
    [btn_medicationNo setTitleColor:kLabelColor forState:UIControlStateNormal];
    [btn_alergisNo setTitleColor:kLabelColor forState:UIControlStateNormal];
    [btn_alergisYes setTitleColor:kLabelColor forState:UIControlStateNormal];
    ...
    lbl_hlpHintMessage.textColor = kLabelColor;
    lbl_disclaimerText.textColor = kLabelColor;
    lbl_ParentName.textColor = kLabelColor;
    lbl_parentContact.textColor = kLabelColor;
    lbl_RelationShip.textColor = kLabelColor;

    // set font type and size
    lbl_sex.font=[UIFont fontWithName:RobotoMediumFont size:LabelFieldFontSize];
    lbl_DOB.font=[UIFont fontWithName:RobotoMediumFont size:LabelFieldFontSize];
    lbl_name.font=[UIFont fontWithName:RobotoMediumFont size:LabelFieldFontSize];
    lbl_specialNeeds.font = [UIFont fontWithName:RobotoMediumFont size:LabelFieldFontSize];
    lbl_alergies.font = [UIFont fontWithName:RobotoMediumFont size:LabelFieldFontSize];
    lbl_medication.font = [UIFont fontWithName:RobotoMediumFont size:LabelFieldFontSize];
    lbl_helpFullHint.font = [UIFont fontWithName:RobotoMediumFont size:LabelFieldFontSize];
    lbl_favouriteFood.font = [UIFont fontWithName:RobotoMediumFont size:LabelFieldFontSize];
    lbl_favouriteCartoon.font = [UIFont fontWithName:RobotoMediumFont size:LabelFieldFontSize];
    lbl_favouriteBook.font = [UIFont fontWithName:RobotoMediumFont size:LabelFieldFontSize];
    lbl_hlpHintMessage.font =  [UIFont fontWithName:RobotoMediumFont size:10.0];
    lbl_disclaimerText.font =  [UIFont fontWithName:RobotoMediumFont size:10.0];
    lbl_RelationShip.font = [UIFont fontWithName:RobotoMediumFont size:LabelFieldFontSize];
    lbl_ParentName.font = [UIFont fontWithName:RobotoMediumFont size:LabelFieldFontSize];
    lbl_parentContact.font = [UIFont fontWithName:RobotoMediumFont size:LabelFieldFontSize];
    btn_sex.titleLabel.font = [UIFont fontWithName:RobotoRegularFont size:LabelFieldFontSize];
    btn_relationShip.titleLabel.font = [UIFont fontWithName:RobotoRegularFont size:LabelFieldFontSize];
    btn_specialNeed.titleLabel.font = [UIFont fontWithName:RobotoRegularFont size:LabelFieldFontSize];
...
- (IBAction)onClickChooseDOB:(id)sender {
    ...
    [self.view endEditing:YES];
    [view_dob setFrame:CGRectMake(0,kScreenHeight-310, self.view.frame.size.width, view_dob.frame.size.height)];
...
- (IBAction)onClickDoneDOB:(id)sender {
    ...
    datePicker.maximumDate=[NSDate date];
    [view_dob setFrame:CGRectMake(0,kScreenHeight+10, view_dob.frame.size.width, view_dob.frame.size.height)];
    ...
    if ([self checkUserData]) {
        if ([self checkStatus]) {
            if (self.checkValue == 1 || self.checkValue == 2) {
                uniqueId= [self generateUUID];
                NSMutableDictionary *dict_ChildProfile = [[NSMutableDictionary alloc]init];
                [dict_ChildProfile setSafeObject:self.parentInfo.tokenData forKey:kToken];
                if (self.checkValue == 2) {
            ...
            {
                DDLogInfo(@"unique id is %@",uniqueId);
                if ([self checkUserData]) {
                    uniqueId= [self generateUUID];
                    NSMutableDictionary *dict_ChildProfile = [[NSMutableDictionary alloc]init];
                    [dict_ChildProfile setSafeObject:txt_name.text forKey:kChildName];
                    ...
                    [dict_ChildProfile setSafeObject:txt_favouriteCortoon.text forKey:kChildFavCartoon];
                    [dict_ChildProfile setSafeObject:txtView_helpFullHint.text forKey:kChildNotes];
                    [dict_ChildProfile setSafeObject:str_specialNeedsStatus forKey:kChildSpecialNeedsStatus];
                    [dict_ChildProfile setSafeObject:txt_specialNeeds.text forKey:kChildSpecialNeeds];
                    [dict_ChildProfile setSafeObject:btn_relationShip.titleLabel.text forKey:kChildRelation];
                    if (![btn_relationShip.titleLabel.text isEqualToString:@"Parent"]&&![btn_relationShip.titleLabel.text isEqualToString:@"Legal guardian"]) {
                        [dict_ChildProfile setSafeObject:txt_parentName.text forKey:kRealtionName];
                    ...
                    DDLogInfo(@"array is %@",array_ChildProfilePic);
                    NSString *str_childCount = [NSString stringWithFormat:@"%d", childCount];
                    [dict_kidsProfile setSafeObject:dict_ChildProfile forKey:str_childCount];
                    [registrationView.dict_loginData setSafeObject:dict_kidsProfile forKey:kChildProfile];
                    registrationView.array_childProfilePic = [array_ChildProfilePic mutableCopy];
...
-(void)addImages
{
    ...
    str_medicatorStatus = @"No";
    str_specialNeedsStatus = @"No";
    [btn_alergisNo setImage:[UIImage imageNamed:@"On"] forState:UIControlStateSelected];
    [btn_alergisNo setImage:[UIImage imageNamed:@"Off"] forState:UIControlStateNormal];
    [btn_specialNeedsNo setImage:[UIImage imageNamed:@"On"] forState:UIControlStateSelected];
    [btn_specialNeedsNo setImage:[UIImage imageNamed:@"Off"] forState:UIControlStateNormal];
    [btn_medicationNo setImage:[UIImage imageNamed:@"On"] forState:UIControlStateSelected];
    [btn_medicationNo setImage:[UIImage imageNamed:@"Off"] forState:UIControlStateNormal];
    [btn_specialNeedsYes setImage:[UIImage imageNamed:@"On"] forState:UIControlStateSelected];
    [btn_specialNeedsYes setImage:[UIImage imageNamed:@"Off"] forState:UIControlStateNormal];
    [btn_alergisYes setImage:[UIImage imageNamed:@"On"] forState:UIControlStateSelected];
    [btn_alergisYes setImage:[UIImage imageNamed:@"Off"] forState:UIControlStateNormal];
    [btn_medicationYes setImage:[UIImage imageNamed:@"On"] forState:UIControlStateSelected];
    [btn_medicationYes setImage:[UIImage imageNamed:@"Off"] forState:UIControlStateNormal];
    ...
    switch (requestId) {
        case 1:
            if([[dict_responseObj valueForKey:kStatus] isEqualToString:kStatusSuccess]){
                ...
                if (self.checkValue == 1) {
                    [ApplicationManager getInstance].parentInfo.parentChildCountName = @"1";
                }
                [[NSNotificationCenter defaultCenter] postNotificationName:@"Add/Update Child" object:nil];
