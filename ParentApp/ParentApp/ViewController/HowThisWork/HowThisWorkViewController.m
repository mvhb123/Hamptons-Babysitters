...
@interface HowThisWorkViewController ()

@end

@implementation HowThisWorkViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view from its nib.
    self.navigationItem.title = @"How This Works";
    NSURL *url = [NSURL URLWithString:kHowThisWorksUrl];
