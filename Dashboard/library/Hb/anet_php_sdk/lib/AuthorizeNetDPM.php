        ...
        <form method="post" action="'.$post_url.'">
            ...
            <fieldset>
                <div>
                    ...
                    <input type="text" class="text" size="15" name="x_first_name" value="'.$address['firstname'].'"></input>
                </div>
                <div>
                    <label>Last Name</label>
                    <input type="text" class="text" size="14" name="x_last_name" value="'.$address['lastname'].'"></input>
                </div>
            </fieldset>
            <fieldset>
                <div>
                    <label>Address</label>
                    <input type="text" class="text" size="26" name="x_address" value="'.$address['streat_address'].'"></input>
                </div>
                <div>
                    <label>City</label>
                    <input type="text" class="text" size="15" name="x_city" value="'.$address['city'].'"></input>
                </div>
            </fieldset>
            <fieldset>
                <div>
                    <label>State</label>';
                    $t='';
                    $form_state='<select name="x_state" id="states">';
                ...
                <div>
                    ...
                    <input type="text" class="text" size="9" name="x_zip" value="'.$address['zipcode'].'"></input>
                </div>
                <div>
                    <label>Country</label>';
                    $t='';
                    $form_country='<select name="x_country" onchange="changeState(this);">';
