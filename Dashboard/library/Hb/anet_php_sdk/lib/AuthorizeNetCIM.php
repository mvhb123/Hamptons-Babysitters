...
class AuthorizeNetCIM extends AuthorizeNetRequest
{
   ...
   private $_validationMode = "none"; // "none","testMode","liveMode"
    ...
    {
    	$this->_api_login =AUTHORIZENET_LOGIN_ID;
    	
    	$this->_transaction_key = AUTHORIZENET_TRAN_KEY;
    ...
    /**
     * Create a customer profile., added by rati because old developer customize this code and make this shot
     *
     ...
     */
    public function createCustomerProfileOriginal($customerProfile, $validationMode = "none")
    {
     ...
     * @return AuthorizeNetCIM_Response
     */
    public function createCustomerProfile($customerProfile,$id, $validationMode = "none")
    {
        ...
        $profile = $this->_xml->addChild("profile");
        $profile->addChild('merchantCustomerId',$id);
        $profile->addChild('email',$customerProfile);
    ...
    public function createCustomerPaymentProfile($customerProfileId, $paymentProfile, $validationMode = "none")
    {
        ...
        $characters = $profile->addChild('billTo');
 		$characters->addChild('firstName',$paymentProfile['firstname']);
      	$characters->addChild('lastName',$paymentProfile['lastname']);

      	$characters1 = $profile->addChild('payment');
        $character2  = $characters1->addChild('creditCard');
        
      	$character2->addChild('cardNumber',$paymentProfile['cardNumber']);
        $character2->addChild('expirationDate',$paymentProfile['expirationDate']);
	        
    	// print_r($this->_sendRequest());die;
    ...
    public function createCustomerShippingAddress($customerProfileId, $shippingAddress)
    {
        ...
        $address->addChild('firstName',$shippingAddress['firstname']);
        $address->addChild('lastName',$shippingAddress['lastname']);
        $address->addChild('phoneNumber',$shippingAddress['phonenumber']);
     ...
     * @return AuthorizeNetCIM_Response
     */
    public function createCustomerProfileTransaction_bk($transactionType, $transaction, $extraOptionsString = "")
    {
     ...
     * @return AuthorizeNetCIM_Response
     */
    public function createCustomerProfileTransactionOriginal($transactionType, $transaction, $extraOptionsString = "")
    {
        $this->_constructXml("createCustomerProfileTransactionRequest");
        $transactionParent = $this->_xml->addChild("transaction");
        $transactionChild = $transactionParent->addChild("profileTrans" . $transactionType);
    ...
    public function createCustomerProfileTransaction($payment_details)
    {
    	$this->_constructXml("createCustomerProfileTransactionRequest");
    	$transactionParent = $this->_xml->addChild("transaction");
    	
    	//$tran=$transactionParent->addChild("profileTransAuthOnly");
    	$tran=$transactionParent->addChild("profileTransAuthCapture");
    	
    	$tran->addChild("amount",$payment_details['amount']);
    	$tran->addChild("customerProfileId",$payment_details['authorizenet_profile_id']);
    	$tran->addChild("customerPaymentProfileId",$payment_details['authorizenet_payment_profile_id']);
    	
    	$tran->addChild("customerShippingAddressId",$payment_details['authorizenet_shipping_id']);
     ...
     * @return AuthorizeNetCIM_Response
     */
    public function updateCustomerProfile($id,$customerProfileId,$customerProfile, $validationMode = "none")
    {
       ...
       // $customerProfile->customerProfileId = $customerProfileId;
        ...
        $profile->addChild('merchantCustomerId',$id);
        $profile->addChild('email',$customerProfile);
        $profile->addChild('customerProfileId',$customerProfileId);
        //$this->_addObject($profile, $customerProfile);
          //print_r($this->_sendRequest());die;
     ...
     * @return AuthorizeNetCIM_Response
     */
    public function updateCustomerPaymentProfileOriginal($customerProfileId, $customerPaymentProfileId, $paymentProfile, $validationMode = "none")
    {
        $this->_validationMode = $validationMode;
     ...
     * @return AuthorizeNetCIM_Response
     */
    public function updateCustomerPaymentProfile($id,$customerProfileId, $customerPaymentProfileId, $paymentProfile, $validationMode = "testMode")
    {
      //  $this->_validationMode = $validationMode;
        $this->_constructXml("updateCustomerPaymentProfileRequest");
        $this->_xml->addChild("customerProfileId", $customerProfileId);
      //  $paymentProfile->customerPaymentProfileId = $customerPaymentProfileId;
        ...
        $profile->addChild("customerPaymentProfileId",$customerPaymentProfileId);
    ...
    {
    	//by namraat
    	//$this->_api_login='2P3bj7A54x';
    	//$this->_transaction_key='962C2q3GJw7zvW3B';
...
class AuthorizeNetCIM_Response extends AuthorizeNetXMLResponse
{
    ...
    /**
     * create a customer payment profile from transaction.
     */
    public function createCustomerProfileFromTransaction($tran_id)
    {
    	$this->_constructXml("createCustomerProfileFromTransactionRequest");
    	$this->_xml->addChild("transId",$tran_id);
    	//print_r($this->_sendRequest());die;
    	return $this->_sendRequest();
    }
