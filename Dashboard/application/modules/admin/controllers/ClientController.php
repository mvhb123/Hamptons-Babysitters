...
//                                }
    ...
    public function assignAction()
    {
        ...
        $jstatus=$this->jobs->get_job_status($this->job_id);
        if($jstatus=='new' || $jstatus=='pending')
        {
        	$openjob = true;
        }
        else 
        {
        	...
        	$errordata['message'] = "Job has been already ".$jstatus.".";
        }
        ...
        //by namrata to auto confirm
            ...
            if (!empty($_POST['sitter_id'])) {
                ...
                $assignee = 'admin';
                $confirmresult=$this->jobs->confirmJob($this->job_id, $sitter, $assignee);
...
//to insert in to transaction history
    ...
    public function removeallAction()
    {
    	...
    	{	
    		$jstatus=$this->jobs->get_job_status($job_id);
    		if($jstatus!='new' && $jstatus!='pending')
    		{
    			$data = array();
    			$data['status'] = "error";
    	...
    	$data = array();
    	$data['status'] = "success";
    	$data['message']="Removed all sitters successfully.";
    	echo json_encode($data);
    	die;
    }
}
