...
- (id)initWithTitle:(NSString *)aTitle options:(NSArray *)aOptions xy:(CGPoint)point size:(CGSize)size isMultiple:(BOOL)isMultiple
{
    ...
    float height = MIN(size.height, [aOptions count]*44);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
   ...
   DropDownViewCell *cell = [[DropDownViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIdentity];
...
//                                      rect.size.width - 2 * DROPDOWNVIEW_SCREENINSET, 2);
    ...
    [[UIColor colorWithRed:R/255 green:G/255 blue:B/255 alpha:1.0] setFill];
