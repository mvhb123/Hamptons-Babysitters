...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil)
    {
        ...
        [cell.textLabel setFont:[UIFont fontWithName:Font_RobotoCondensed_Regular size:FontSizeForRobotoRegular]];
        [cell.textLabel setTextColor:kColorGrayDark];
...
- (void)addSeparatorImageToCell:(UITableViewCell *)cell
{
    ...
    [separatorImageView setImage:[ApplicationManager imageWithColor:kColorGrayLight]];
    separatorImageView.alpha=0.5f;
