...
class AuthorizeCimLib
{
	...
	//
	// Set multiple Parameters to send to Authorize.net
	//
	...
	private function _build_transaction_profile_xml($type)
	{
		...
		$body .='</transaction>';
		$body .="<extraOptions><![CDATA[x_duplicate_window='15']]></extraOptions>";
	...
	private function _parseResults()
	{
		...
		$this->_parsedresponse = $this->_xml2array($this->_response);
		$this->_responsecall = str_ireplace('Request', 'Response', $this->_call);
		//print_r($this->_parsedresponse);
