 ...
 * (c) Rativardhan Singh, rativardhan@gmail.com
 * 2012
*/
...
/*******************************
    ...
    * @return <string>
    */
    protected function generatePayload($message, $badge = NULL, $sound = NULL, $newstand = false, $data) {
...
*******************************/
    ...
    function __construct($params) {
        ...
        if($this->type=='sitter')
        	$cert_file=$this->_ci->config->item('PermissionFileSitter','apn');
        else 
        	$cert_file=$this->_ci->config->item('PermissionFileParent','apn');
        ...
        $this->keyCertFilePath = $cert_file;//$this->_ci->config->item('PermissionFile','apn');
     ...
     * @param <string> $sound
     */
    public function sendMessage($deviceToken, $message, $badge = NULL, $sound = NULL, $expiry = '', $newstand = false,$data=array())
    {
        $this->error = '';
        ...
        $payload = $this->generatePayload($message, $badge, $sound, $newstand,$data);
